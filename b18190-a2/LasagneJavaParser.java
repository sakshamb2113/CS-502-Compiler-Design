/* Generated By:JavaCC: Do not edit this line. LasagneJavaParser.java */
import syntaxtree.*;
import java.util.Vector;


public class LasagneJavaParser implements LasagneJavaParserConstants {
  ...
  static public LasagneJavaParserTokenManager token_source;
  ...
  public LasagneJavaParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public LasagneJavaParser(java.io.InputStream stream, String encoding) {
    ...
    token_source = new LasagneJavaParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public LasagneJavaParser(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public LasagneJavaParser(LasagneJavaParserTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(LasagneJavaParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
